// lqr_controller.cpp
// Controlador LQR completo para pendulo invertido com 2 motores e 2 encoders
// Versao de PERFORMANCE MAXIMA DE HARDWARE (Torque de arranque agressivo)
// Ganhos originais do usuario estao 100% preservados.
//
// Pinos:
//   Motor 1: PWM PB3 (TIM2_CH2), IN1=PB4, IN2=PB5
//   Motor 2: PWM PA2 (TIM9_CH1), IN3=PB8, IN4=PB9
...
// ─── GANHOS LQR ORIGINAIS (Mantidos intactos) ───────────
...
// ─── PARAMETROS DO ENCODER (Q6.25) ──────────────────────
#define ENCODER_CPR         1320
#define WHEEL_DIAM_M        Q6(0.0654)
#define WHEEL_CIRCUM_M      Q6(0.20548)        // pi * 0.0654
#define M_PER_COUNT         Q6(0.00015567)     // WHEEL_CIRCUM_M / ENCODER_CPR

// ─── PARAMETROS DO CONTROLE (Q6.25) ─────────────────────
#define TS                  Q6(0.005)
#define THETA_MAX           Q6(0.5236)         // 30 graus em rad
#define FORCA_MAX           Q16(2.5)          
#define PWM_PERIOD          999

// ─── OFFSET DE EQUILIBRIO ───────────────────────────────
...
// ─── PARAMETROS DE HARDWARE ULTRA-AGRESSIVOS ────────────
#define PWM_DEADBAND_RAW    2           
#define PWM_MIN             140         // MAXIMA EXPLOSÃO: Garante torque massivo instantaneo para vencer o peso do robo
#define PWM_BALANCE_MIN     130         // Mantem os motores altamente responsivos no ponto de equilibrio

// ─── FILTRO COMPLEMENTAR RADICAL (Q6.25) ────────────────
#define ALPHA            Q6(0.88)       // Reduzido para 0.88 para eliminar qualquer atraso de leitura
#define ONE_MINUS_ALPHA  Q6(0.12)
#define RAD_PER_DEG      Q6(0.017453)   // pi/180
...
static void controle_lqr(void)
{
    ...
    // Seus ganhos continuam 100% originais aqui
